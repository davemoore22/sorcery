...
#include "drawables/define.hpp"				// for BACK_FROM_VICTORY, ABORT...
...
Sorcery::Victory::~Victory() {}

auto Sorcery::Victory::_initialise() -> bool {

	return true;
}

auto Sorcery::Victory::start(void) -> int {

	_ctx.controller->go_to(Enums::Screen::VICTORY);
	_ctx.controller->initialise();

	fade_in(Enums::Screen::VICTORY, QUICK_FADE);
...
auto Sorcery::Victory::stop(void) -> void {

	fade_out(Enums::Screen::VICTORY, QUICK_FADE);
}
