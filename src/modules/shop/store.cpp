...
#include "modules/shop/buy.hpp"				// for Buy
#include "modules/shop/identify.hpp"		// for Identify
#include "modules/shop/sell.hpp"			// for Sell
#include "modules/shop/uncurse.hpp"			// for Uncurse
