...
Sorcery::Menu::Menu(System& system, Display& display, Graphics& graphics, MenuType type): _system {system},
	...
	case MenuType::OPTIONS:
		...
		_add_item(6, MenuItemType::ENTRY, MenuItem::OP_ALLOW_MIXED_ALIGNMENT_PARTY, (*_display.string)["GAME_ALLOW_MIXED_ALIGNMENT"], true, ConfigOption::ALLOW_MIXED_ALIGNMENT_PARTY);
		_add_item(7, MenuItemType::ENTRY, MenuItem::OP_STAT_LOSS_ON_LEVEL_UP, (*_display.string)["GAME_STAT_LOSS_LEVEL_GAIN"], true, ConfigOption::STAT_LOSS_ON_LEVEL_UP);
		_add_item(8, MenuItemType::ENTRY, MenuItem::OP_REROLL_HIT_POINTS_ON_LEVEL_GAIN, (*_display.string)["GAME_REROLL_HIT_POINTS"], true, ConfigOption::REROLL_HIT_POINTS_ON_LEVEL_GAIN);
		_add_item(9, MenuItemType::ENTRY, MenuItem::OP_STAT_RESET_ON_CLASS_CHANGE, (*_display.string)["GAME_STAT_RESET_CLASS_CHANGE"], true, ConfigOption::STAT_RESET_ON_CLASS_CHANGE);
		_add_item(10, MenuItemType::ENTRY, MenuItem::OP_AGING_ON_CLASS_CHANGE, (*_display.string)["GAME_AGING_CLASS_CHANGE"], true, ConfigOption::AGING_ON_CLASS_CHANGE);
		_add_item(11, MenuItemType::ENTRY, MenuItem::OP_ALLOW_AMBUSH_HIDE, (*_display.string)["GAME_ALLOW_AMBUSH_HIDE"], true, ConfigOption::ALLOW_AMBUSH_HIDE);
		_add_item(12,MenuItemType::ENTRY, MenuItem::OP_ALLOW_RANGED_WEAPONS, (*_display.string)["GAME_ALLOW_RANGED_WEAPONS"], true, ConfigOption::ALLOW_RANGED_WEAPONS);
		_add_item(13, MenuItemType::ENTRY, MenuItem::OP_SPELLCASTING_IN_SURPRISE_ROUND, (*_display.string)["GAME_SPELL_CASTING_SURPRISE_ROUND"], true, ConfigOption::SPELLCASTING_IN_SURPRISE_ROUND);
		_add_item(14, MenuItemType::ENTRY, MenuItem::OP_BATCH_HEALING_AFTER_RETURN_TO_CASTLE, (*_display.string)["GAME_BATCH_HEALING_AFTER_RETURN"], true, ConfigOption::BATCH_HEALING_AFTER_RETURN_TO_CASTLE);
		_add_item(15, MenuItemType::ENTRY, MenuItem::OP_REROLL_ONES_ON_DICE, (*_display.string)["GAME_REROLL_ONES"], true, ConfigOption::REROLL_ONES_ON_DICE);
		_add_item(16, MenuItemType::SPACER, MenuItem::SPACER, (*_display.string)["MENU_SPACER"]);
		_add_item(17, MenuItemType::SPACER, MenuItem::SPACER, (*_display.string)["MENU_SPACER"]);
		_add_item(18, MenuItemType::ENTRY, MenuItem::OP_WIREFRAME_MODE, (*_display.string)["GRAPHICS_WIREFRAME"], true, ConfigOption::WIREFRAME_MODE);
		_add_item(19, MenuItemType::ENTRY, MenuItem::OP_DISPLAY_TEXTURES, (*_display.string)["GRAPHICS_TEXTURES"], true, ConfigOption::DISPLAY_TEXTURES);
		_add_item(20, MenuItemType::ENTRY, MenuItem::OP_DISPLAY_TRAPS, (*_display.string)["GRAPHICS_TRAPS"], true, ConfigOption::DISPLAY_TRAPS);
		_add_item(21, MenuItemType::ENTRY, MenuItem::OP_DISPLAY_TELEPORTERS, (*_display.string)["GRAPHICS_TELEPORTERS"], true, ConfigOption::DISPLAY_TELEPORTERS);
		_add_item(22, MenuItemType::ENTRY, MenuItem::OP_DISPLAY_ENCOUNTERS, (*_display.string)["GRAPHICS_ENCOUNTERS"], true, ConfigOption::DISPLAY_ENCOUNTERS);
		_add_item(23, MenuItemType::ENTRY, MenuItem::OP_DISPLAY_PROGRESS, (*_display.string)["GRAPHICS_PROGRESS"], true, ConfigOption::DISPLAY_PROGRESS);
		_add_item(24, MenuItemType::SPACER, MenuItem::SPACER, (*_display.string)["MENU_SPACER"]);
...
auto Sorcery::Menu::_select_first_enabled() -> void {
	for (std::vector<MenuEntry>::const_iterator it = items.begin(); it != items.end(); ++it)
		if (((*it).type == MenuItemType::ENTRY) && ((*it).enabled)) {
			selected = it;
			return;
		}
}
