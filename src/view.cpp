...
auto Sorcery::View::_load_tile_views() -> void {
	...
	const auto stairs_colour{
		sf::Color{std::stoull(floor_c["stairs_colour"].value(), 0, 16)}};
	const auto elevator_colour{
		sf::Color{std::stoull(floor_c["elevator_colour"].value(), 0, 16)}};
	...
	// Tile the player is standing on
	{
		...
		_set_vertex_array(tileview.ceiling, sf::Vector2f{95, 15},
			...
			ceiling_colour);
		_set_vertex_array(tileview.down, sf::Vector2f{88, 167},
			sf::Vector2f{95, 160}, sf::Vector2f{208, 160},
			sf::Vector2f{215, 167}, stairs_colour);
		_set_vertex_array(tileview.up, sf::Vector2f{95, 15},
			sf::Vector2f{88, 8}, sf::Vector2f{215, 8}, sf::Vector2f{208, 15},
			stairs_colour);
		...
		_set_vertex_array(tileview.back_door, sf::Vector2f{87, 153},
			sf::Vector2f{87, 23}, sf::Vector2f{217, 23},
			sf::Vector2f{217, 153});
		_set_vertex_array(tileview.left_side_wall, sf::Vector2f{8, 167},
			sf::Vector2f{8, 8}, sf::Vector2f{87, 8}, sf::Vector2f{87, 167});
		_set_vertex_array(tileview.left_side_door, sf::Vector2f{8, 167},
			sf::Vector2f{8, 8}, sf::Vector2f{87, 8}, sf::Vector2f{87, 167});
		_set_vertex_array(tileview.right_side_wall, sf::Vector2f{216, 167},
			sf::Vector2f{216, 8}, sf::Vector2f{296, 8}, sf::Vector2f{296, 167});
		_set_vertex_array(tileview.right_side_door, sf::Vector2f{216, 167},
			sf::Vector2f{216, 8}, sf::Vector2f{296, 8}, sf::Vector2f{296, 167});
	...
	// Tile in Front of the Player
	{
		...
		_set_vertex_array(tileview.ceiling, sf::Vector2f{127, 47},
			...
			ceiling_colour);
		_set_vertex_array(tileview.down, sf::Vector2f{112, 143},
			sf::Vector2f{127, 128}, sf::Vector2f{176, 128},
			sf::Vector2f{191, 143}, stairs_colour);
		_set_vertex_array(tileview.up, sf::Vector2f{127, 47},
			sf::Vector2f{112, 32}, sf::Vector2f{191, 32}, sf::Vector2f{176, 47},
			stairs_colour);
		...
		_set_vertex_array(tileview.back_wall, sf::Vector2f{119, 121},
			...
			sf::Vector2f{185, 121});
		_set_vertex_array(tileview.back_door, sf::Vector2f{119, 121},
			sf::Vector2f{119, 55}, sf::Vector2f{185, 55},
			sf::Vector2f{185, 121});

		_set_vertex_array(tileview.left_side_wall, sf::Vector2f{87, 153},
			sf::Vector2f{87, 23}, sf::Vector2f{120, 23},
			sf::Vector2f{120, 153});
		_set_vertex_array(tileview.left_side_door, sf::Vector2f{87, 153},
			sf::Vector2f{87, 23}, sf::Vector2f{120, 23},
			sf::Vector2f{120, 153});
		_set_vertex_array(tileview.right_side_wall, sf::Vector2f{184, 121},
			sf::Vector2f{184, 55}, sf::Vector2f{217, 23},
			sf::Vector2f{217, 153});
		_set_vertex_array(tileview.right_side_door, sf::Vector2f{184, 121},
			sf::Vector2f{184, 55}, sf::Vector2f{217, 23},
			sf::Vector2f{217, 153});
	...
	// Tile 2 in Front of the Player
	{
		...
		_set_vertex_array(tileview.back_wall, sf::Vector2f{135, 105},
			...
			sf::Vector2f{169, 105});
		_set_vertex_array(tileview.back_door, sf::Vector2f{135, 105},
			sf::Vector2f{139, 71}, sf::Vector2f{169, 71},
			sf::Vector2f{168, 105});
		_set_vertex_array(tileview.left_side_wall, sf::Vector2f{119, 120},
			sf::Vector2f{119, 54}, sf::Vector2f{135, 71},
			sf::Vector2f{135, 120});
		_set_vertex_array(tileview.left_side_door, sf::Vector2f{119, 120},
			sf::Vector2f{119, 54}, sf::Vector2f{135, 71},
			sf::Vector2f{135, 120});
		_set_vertex_array(tileview.right_side_wall, sf::Vector2f{168, 105},
			sf::Vector2f{168, 71}, sf::Vector2f{184, 54},
			sf::Vector2f{184, 120});
		_set_vertex_array(tileview.right_side_door, sf::Vector2f{168, 105},
			sf::Vector2f{168, 71}, sf::Vector2f{184, 54},
			sf::Vector2f{184, 120});
	...
	// Tile 3 in Front of the Player
	{
		...
		_set_vertex_array(tileview.back_door, sf::Vector2f{143, 97},
			sf::Vector2f{143, 79}, sf::Vector2f{161, 79},
			sf::Vector2f{161, 97});
		_set_vertex_array(tileview.left_side_wall, sf::Vector2f{135, 105},
			sf::Vector2f{135, 71}, sf::Vector2f{144, 79},
			sf::Vector2f{144, 105});
		_set_vertex_array(tileview.left_side_door, sf::Vector2f{135, 105},
			sf::Vector2f{135, 71}, sf::Vector2f{144, 79},
			sf::Vector2f{144, 105});
		_set_vertex_array(tileview.right_side_wall, sf::Vector2f{160, 97},
			sf::Vector2f{160, 79}, sf::Vector2f{168, 71},
			sf::Vector2f{168, 105});
	...
	// Tile to the Immediate Left of the Player
	{
		...
		_set_vertex_array(tileview.ceiling, sf::Vector2f{8, 15},
			...
			ceiling_colour);
		_set_vertex_array(tileview.down, sf::Vector2f{8, 167},
			sf::Vector2f{8, 160}, sf::Vector2f{63, 160}, sf::Vector2f{56, 167},
			stairs_colour);
		_set_vertex_array(tileview.up, sf::Vector2f{8, 15}, sf::Vector2f{8, 8},
			sf::Vector2f{56, 8}, sf::Vector2f{63, 15}, stairs_colour);
	...
	// Tile to the Immediate Right of the Player
	{
		...
		_set_vertex_array(tileview.ceiling, sf::Vector2f{232, 15},
			...
			ceiling_colour);
		_set_vertex_array(tileview.down, sf::Vector2f{239, 167},
			sf::Vector2f{232, 160}, sf::Vector2f{295, 160},
			sf::Vector2f{295, 167}, stairs_colour);
		_set_vertex_array(tileview.up, sf::Vector2f{232, 15},
			sf::Vector2f{239, 8}, sf::Vector2f{295, 8}, sf::Vector2f{295, 15},
			stairs_colour);
	...
	// Tile to the left and one in front
	{
		...
		_set_vertex_array(tileview.ceiling, sf::Vector2f{46, 47},
			...
			ceiling_colour);
		_set_vertex_array(tileview.down, sf::Vector2f{16, 143},
			sf::Vector2f{46, 128}, sf::Vector2f{95, 128}, sf::Vector2f{80, 143},
			stairs_colour);
		_set_vertex_array(tileview.up, sf::Vector2f{46, 47},
			sf::Vector2f{16, 32}, sf::Vector2f{80, 32}, sf::Vector2f{95, 47},
			stairs_colour);
		...
		_set_vertex_array(tileview.back_wall, sf::Vector2f{55, 121},
			...
			sf::Vector2f{120, 121});
		_set_vertex_array(tileview.back_door, sf::Vector2f{55, 121},
			sf::Vector2f{55, 55}, sf::Vector2f{120, 55},
			sf::Vector2f{120, 121});
	...
	// Tile to the left and two in front
	{
		...
		_set_vertex_array(tileview.back_wall, sf::Vector2f{103, 105},
			...
			sf::Vector2f{136, 105});
		_set_vertex_array(tileview.back_door, sf::Vector2f{103, 105},
			sf::Vector2f{103, 71}, sf::Vector2f{136, 71},
			sf::Vector2f{136, 105});
	...
	// Tile to the left and three in front
	{
		...
		_set_vertex_array(tileview.back_wall, sf::Vector2f{127, 97},
			...
			sf::Vector2f{144, 97});
		_set_vertex_array(tileview.back_door, sf::Vector2f{127, 97},
			sf::Vector2f{127, 79}, sf::Vector2f{144, 79},
			sf::Vector2f{144, 97});
	...
	// Tile to the right and one in front
	{
		...
		_set_vertex_array(tileview.ceiling, sf::Vector2f{200, 47},
			...
			ceiling_colour);
		_set_vertex_array(tileview.down, sf::Vector2f{215, 143},
			sf::Vector2f{200, 128}, sf::Vector2f{257, 128},
			sf::Vector2f{287, 143}, stairs_colour);
		_set_vertex_array(tileview.up, sf::Vector2f{200, 47},
			sf::Vector2f{215, 32}, sf::Vector2f{287, 32}, sf::Vector2f{257, 47},
			stairs_colour);
		...
		_set_vertex_array(tileview.back_wall, sf::Vector2f{184, 121},
			...
			sf::Vector2f{249, 121});
		_set_vertex_array(tileview.back_door, sf::Vector2f{184, 121},
			sf::Vector2f{184, 55}, sf::Vector2f{249, 55},
			sf::Vector2f{249, 121});
	...
	// Tile to the right and two in front
	{
		...
		// Set Vertex Arrays
		_set_vertex_array(tileview.darkness, sf::Vector2f{168, 105},
			sf::Vector2f{168, 72}, sf::Vector2f{199, 72},
			sf::Vector2f{199, 105}, darkness_colour);
		_set_vertex_array(tileview.side_darkness, sf::Vector2f{168, 105},
		...
		_set_vertex_array(tileview.back_wall, sf::Vector2f{168, 105},
			...
			sf::Vector2f{201, 105});
		_set_vertex_array(tileview.back_door, sf::Vector2f{168, 105},
			sf::Vector2f{168, 71}, sf::Vector2f{201, 71},
			sf::Vector2f{201, 105});
	...
	// Tile to the right and three in front
	{
		...
		_set_vertex_array(tileview.darkness, sf::Vector2f{168, 105},
			sf::Vector2f{168, 72}, sf::Vector2f{199, 72},
			sf::Vector2f{199, 105}, darkness_colour);
		_set_vertex_array(tileview.side_darkness, sf::Vector2f{161, 98},
			sf::Vector2f{161, 79}, sf::Vector2f{168, 72},
		...
		_set_vertex_array(tileview.back_wall, sf::Vector2f{160, 97},
			...
			sf::Vector2f{177, 97});
		_set_vertex_array(tileview.back_door, sf::Vector2f{160, 97},
			sf::Vector2f{160, 79}, sf::Vector2f{177, 79},
			sf::Vector2f{177, 97});
