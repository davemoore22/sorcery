...
auto Sorcery::Museum::stop() -> void {

	_display->stop_bg_movie();
}

auto Sorcery::Museum::_generate_display() -> void {

	_reset_components();
	_initalise_components();
	_display->generate("museum");
	_place_components();
}

auto Sorcery::Museum::_reset_components() -> void {
...
auto Sorcery::Museum::_draw() -> void {

	_display->display("museum");
