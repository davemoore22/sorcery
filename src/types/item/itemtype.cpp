...
auto Sorcery::ItemType::get_value() const -> std::uint64_t {
...
auto Sorcery::ItemType::set_value(const std::uint64_t value) -> void {
...
auto Sorcery::ItemType::get_can_be_bought() const -> bool {

	return _can_be_bought;
}

auto Sorcery::ItemType::get_can_be_sold() const -> bool {

	return _can_be_sold;
}

auto Sorcery::ItemType::set_can_be_bought(const bool value) -> void {

	_can_be_bought = value;
}

auto Sorcery::ItemType::set_can_be_sold(const bool value) -> void {
