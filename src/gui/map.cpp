...
Sorcery::Map::Map(System *system, Display *display, Graphics *graphics,
	...
	// Outside Frame
	_outside_frame = _factory->make_comp_frame(_layout, _sprites);
}
...
auto Sorcery::Map::_draw_player(MAD direction, int x, int y, float scaling)
	-> void {
...
auto Sorcery::Map::draw(sf::RenderTarget &target, sf::RenderStates states) const
	-> void {
