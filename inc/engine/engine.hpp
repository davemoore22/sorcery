...
class Engine {
	...
	private:
		...
		std::optional<TimePoint> _direction_start;
		std::optional<TimePoint> _direction_current_time;
		bool _show_direction_indicator;
		MenuSelect _get_option;
		MenuSelect _camp_option;
		MenuSelect _action_option;
		MenuSelect _search_option;
		MenuSelect _elevator_a_d_option;
		MenuSelect _elevator_a_f_option;
		bool _monochrome;
		bool _can_run_event;
