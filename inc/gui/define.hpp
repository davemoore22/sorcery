...
inline constexpr auto METHOD_FULL{0};
inline constexpr auto METHOD_QUICK{1};
inline constexpr auto METHOD_RANDOM{2};
...
inline constexpr auto BACK_TO_CHOOSE_METHOD{4};
