...
class ConstCharacterCreate {
	...
	public:
		...
		auto get_start_attribute(const Enums::Character::Attribute attribute) const -> unsigned int;
		auto get_start_attributes() const -> std::map<Enums::Character::Attribute, int>;
	...
	protected:
		...
		auto _get_spells_known(Enums::Magic::SpellType spell_type, unsigned int spell_level) -> unsigned int;
...
class CharacterCreate : public ConstCharacterCreate {
	...
	public:
		...
		auto create_class_alignment(const Enums::Character::Class cclass, const Enums::Character::Align alignment)
			-> void;
		auto finalise() -> void;
	...
	private:
		...
		auto _try_learn_spell(Enums::Magic::SpellType spell_type, unsigned int spell_level) -> bool;
		auto _calculate_sp(Enums::Magic::SpellType spell_type, unsigned int level_mod, unsigned int level_offset)
			-> void;
		auto _set_sp() -> bool;
		auto _update_stat_for_level(Enums::Character::Attribute attribute, std::string stat) -> std::string;
