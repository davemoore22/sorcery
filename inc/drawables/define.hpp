...
inline constexpr auto TRAINING_CREATE{0};
inline constexpr auto SHOP_INSPECT{1};
inline constexpr auto INN_INSPECT{1};
inline constexpr auto INN_STAY{0};
inline constexpr auto RACE_HUMAN{0};
inline constexpr auto RACE_ELF{1};
inline constexpr auto RACE_DWARF{2};
inline constexpr auto RACE_GNOME{3};
inline constexpr auto RACE_HOBBIT{4};
inline constexpr auto ALIGNMENT_GOOD{0};
inline constexpr auto ALIGNMENT_NEUTRAL{1};
inline constexpr auto ALIGNMENT_EVIL{2};
...
inline constexpr auto BACK_TO_EDIT{4};
...
inline constexpr auto INSPECT_MODE_BASE{0};
inline constexpr auto INSPECT_MODE_ACTIONS{1};
...
inline constexpr auto EDIT_MODE_RENAME{1};
inline constexpr auto EDIT_MODE_RECLASS{2};
inline constexpr auto EDIT_MODE_LEGATE{3};
inline constexpr auto INSPECT_MODE_TEMPLE{4};
inline constexpr auto INSPECT_MODE_ROSTER{5};
inline constexpr auto INSPECT_MODE_SHOP{6};
inline constexpr auto INSPECT_MODE_CASTLE{7};
inline constexpr auto INSPECT_MODE_EDGE{8};
inline constexpr auto GO_TO_MAZE{-3};
inline constexpr auto RESTART_MAZE{-4};
inline constexpr auto GO_TO_FRONT_END{-7};
